            ...
            <div class="row">
                ...
                <div class="span4">
                    ...
                    <div id="mc_embed_signup">
                        <form action="http://proteusthemes.us4.list-manage1.com/subscribe/post?u=ea0786485977f5ec8c9283d5c&amp;id=5dad3f35e9"
...
<script>
    if (typeof jQuery == 'undefined') {
        document.write('<script src="<?php \app\classes\Asset::js('jquery.min'); ?>"><\/script>');
    }
</script>

<!--  = _ =  -->
<script src="<?php \app\classes\Asset::js('underscore/underscore-min'); ?>"></script>

<!--  = Bootstrap =  -->
<script src="<?php \app\classes\Asset::js('bootstrap.min'); ?>"></script>

<!--  = Slider Revolution =  -->
<script src="<?php \app\classes\Asset::js('rs-plugin/pluginsources/jquery.themepunch.plugins.min'); ?>"></script>
<script src="<?php \app\classes\Asset::js('rs-plugin/js/jquery.themepunch.revolution.min'); ?>"></script>

<!--  = CarouFredSel =  -->
<script src="<?php \app\classes\Asset::js('jquery.carouFredSel-6.2.1-packed'); ?>"></script>

<!--  = jQuery UI =  -->
<script src="<?php \app\classes\Asset::js('jquery-ui-1.10.3/js/jquery-ui-1.10.3.custom.min'); ?>"></script>
<script src="<?php \app\classes\Asset::js('jquery-ui-1.10.3/touch-fix.min'); ?>"></script>

<!--  = Isotope =  -->
<script src="<?php \app\classes\Asset::js('isotope/jquery.isotope.min'); ?>"></script>

<!--  = Tour =  -->
<script src="<?php \app\classes\Asset::js('bootstrap-tour/build/js/bootstrap-tour.min'); ?>"></script>

<!--  = PrettyPhoto =  -->
<script src="<?php \app\classes\Asset::js('prettyphoto/js/jquery.prettyPhoto'); ?>"></script>

<!--  = Google Maps API =  -->
<script src="http://maps.google.com/maps/api/js?sensor=false"></script>
<script src="<?php \app\classes\Asset::js('goMap/js/jquery.gomap-1.3.2.min'); ?>"></script>
